...
export default function AdmissionsPage() {
    ...
    return (
        <div className="min-h-screen bg-background">
            {/* Header */}
            <Section variant="hero" withGrid spacing="none" className="text-center overflow-hidden bg-grid">

                <div className="container relative z-10 text-center space-y-10 pt-32 pb-24 md:pt-48 md:pb-32 max-w-4xl mx-auto">
                    <Badge variant="outline" className="px-4 py-2 rounded-full glass border-white/10 text-sm font-medium text-slate-300">Your Future Starts Here</Badge>
                    <h1 className="text-5xl md:text-8xl font-black font-heading leading-[1.1] text-white">Join the <br /> <span className="text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-blue-400 to-indigo-400 text-glow">Elite.</span></h1>
            ...
            <Section spacing="default">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-12 relative px-4 md:px-0">
                    <div className="hidden md:block absolute top-16 left-[15%] right-[15%] h-[2px] bg-white/5 -z-10" />
                    {[
            ...
            <Section variant="alternate">
                <div className="text-center space-y-4 mb-24 max-w-3xl mx-auto">
                    <Badge variant="outline" className="px-4 py-2 text-primary border-primary/20 bg-primary/5 uppercase tracking-tighter">Tuition Plans</Badge>
