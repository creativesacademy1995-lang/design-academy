    ...
    <div className="min-h-screen bg-background pb-32 pt-20">
      ...
      <section className="relative py-24 bg-grid border-b border-white/5">
        ...
        <div className="container relative z-10 text-center space-y-8">
          <Badge variant="outline" className="px-4 py-1 text-primary border-primary/20 bg-primary/5 uppercase tracking-tighter">
            Insights & News
          </Badge>

          <h1 className="text-5xl md:text-9xl font-black font-heading text-white leading-[0.9]">
            Word from <br />
