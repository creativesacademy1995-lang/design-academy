    ...
    <section className="relative min-h-[90vh] flex items-center justify-center overflow-hidden pt-20">
      ...
      <div className="container relative z-10">
        <div className="flex flex-col items-center text-center space-y-10 max-w-5xl mx-auto">
          ...
          {/* ✅ Left shape: remove -left-20, add safe margins */}
          <div className="absolute left-6 2xl:left-10 top-1/2 hidden xl:block animate-float animation-delay-500">
          ...
          {/* ✅ Right shape: remove -right-20, add safe margins */}
          <div className="absolute right-6 2xl:right-10 top-1/3 hidden xl:block animate-float">
            <div className="glass p-6 rounded-2xl border-white/10 w-64 -rotate-12">
